 ...
 * generated in the test.client.stubs package. 
...
public class ObjectFactory {
    ...
    private final static QName _UploadResponse_QNAME = new QName("http://server.test/", "uploadResponse");
    private final static QName _Download_QNAME = new QName("http://server.test/", "download");
    private final static QName _Upload_QNAME = new QName("http://server.test/", "upload");
    private final static QName _DownloadResponse_QNAME = new QName("http://server.test/", "downloadResponse");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: test.client.stubs
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.test/", name = "uploadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.test/", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.test/", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.test/", name = "downloadResponse")
